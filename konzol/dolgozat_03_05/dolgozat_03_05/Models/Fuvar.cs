...
namespace dolgozat_03_05.Models
{
    class Fuvar
    {
        ...
        public double viteldij { get => viteldij / 300; set => viteldij = value; }
        public double borravalo { get => borravalo / 300; set => borravalo = value; }
